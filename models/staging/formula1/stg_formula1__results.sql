with
    ...
    renamed as (
        select
            ...
            "RANK" as driver_rank,
            iff(contains(fastestlaptime, '\N'),null,{{ convert_laptime("fastestlaptime") }}) as fastest_lap_time,
            iff(contains(fastestlapspeed, '\N'), null, fastestlapspeed) as fastest_lap_speed,
